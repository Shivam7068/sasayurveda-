// src/components/HospitalInfrastructure.js
...
const infrastructureData = {
  ...
  panchkarmaBlock: [
    ...
    { department: 'Panchakarma therapist/Physician’s room', area: 20 },
...
const InfrastructureSection = ({ title, data }) => (
    ...
    <table className="w-full border-collapse border border-gray-300">
      <thead>
        <tr className="bg-gray-200">
          ...
          <th className="border border-gray-300 px-4 py-2">Area (Sq. mtr.)</th>
        </tr>
      </thead>
      <tbody>
        {data.map((item, index) => (
          <tr key={index}>
            ...
            <td className="border border-gray-300 px-4 py-2">{item.area || item.available}</td>
          </tr>
        ))}
      </tbody>
    </table>
...
const HospitalInfrastructure = () => {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Hospital Infrastructure</h1>
      <InfrastructureSection title="Admin Block" data={infrastructureData.adminBlock} />
      <InfrastructureSection title="OPD Block" data={infrastructureData.opdBlock} />
      <InfrastructureSection title="IPD Block" data={infrastructureData.ipdBlock} />
      <InfrastructureSection title="Operation Theatre Block" data={infrastructureData.operationTheatreBlock} />
      <InfrastructureSection title="Panchkarma Block" data={infrastructureData.panchkarmaBlock} />
      <InfrastructureSection title="Physiotherapy Unit" data={infrastructureData.physiotherapyUnit} />
      <InfrastructureSection title="Clinical Laboratory" data={infrastructureData.clinicalLaboratory} />
      <InfrastructureSection title="Radiology/Sonography Block" data={infrastructureData.radiologySonographyBlock} />
      <InfrastructureSection title="Kitchen and Canteen" data={infrastructureData.kitchenCanteen} />
      <InfrastructureSection title="Store/Mortuary Block" data={infrastructureData.storeMortuaryBlock} />
      <InfrastructureSection title="Other Infrastructure" data={infrastructureData.otherInfrastructure} />
      <div className="mt-6">
        <p className="font-bold">Grand Total Constructed Area:</p>
        <p>2025.00 Sq. mtr.</p>
      </div>
    </div>
  );
