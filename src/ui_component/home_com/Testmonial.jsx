                    ...
                    <Slider {...settings}>
                        {
                            testimonials.map((obj, i) => (
                                <div key={i} className='flex w-full flex-col bg-[#eee] border-none rounded-xl items-center justify-center relative h-[400px]'>
                                    {/* testimonial image  */}
                                    <div className='flex outline-none border-none w-full justify-center items-center'>
                                        <div className='flex w-[150px] h-[150px] rounded-full mt-2 overflow-hidden z-[99] border-4 border-white'>
                                            <img className='h-full w-full object-cover' src={obj.image} alt={obj.name} />
                                        </div>
                                    </div>
                                    {/* name and quote */}
